<template>
  <div class="xxyp-marquee" :style="{height: height + 'px'}">
    <ul class="xxyp-marquee-box" ref="box" :style="{transform: `translate3d(0,${currenTranslateY}px,0)`, transition: `transform ${noAnimate ? 0 : duration}ms`}">
      <slot></slot>
    </ul>
  </div>
</template>
